...
namespace Rhythmic.Graphics.UserInterface
{
    ...
    public class RhythmicAnimatedButton : RhythmicClickableContainer
    {
        ...
        private void load()
        {
            Enabled.BindValueChanged(enabled => this.FadeColour(enabled.NewValue ? Color4.White : RhythmicColors.Gray9, 200, Easing.OutQuint), true);
        }
