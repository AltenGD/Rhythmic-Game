...
{
    public class IconButton : RhythmicAnimatedButton
    {
        public const float BUTTON_SIZE = 30;

        private Color4? iconColour;

        /// <summary>The icon colour. This does not affect <see cref="IconButton.Colour"/>.</summary>
        ...
        /// <summary>The icon scale. This does not affect <see cref="IconButton.Scale"/>.</summary>
        ...
        /// <summary>The size of the <see cref="IconButton"/> while it is not being pressed.</summary>
