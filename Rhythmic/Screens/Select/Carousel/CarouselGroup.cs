...
{
    /// <summary>A group which ensures only one child is selected.</summary>
    public class CarouselGroup : CarouselItem
    {
        ...
        /// <summary>Used to assign a monotonically increasing ID to children as they are added. This member is
        /// incremented whenever a child is added.</summary>
