...
namespace Rhythmic.Screens.Select.Carousel
{
    public class CarouselGroupEagerSelect : CarouselGroup
    {
        ...
        /// <summary>The last selected item.</summary>
        protected CarouselItem LastSelected { get; private set; }

        /// <summary>We need to keep track of the index for cases where the selection is removed but we want to select a new item based on its old location.</summary>
        private int lastSelectedIndex;

        /// <summary>To avoid overhead during filter operations, we don't attempt any selections until after all
