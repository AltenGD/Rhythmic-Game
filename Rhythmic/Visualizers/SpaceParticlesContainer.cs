...
namespace Rhythmic.Visualizers
{
    ...
    {
        /// <summary>Number of milliseconds between addition of a new particle.</summary>
        private const float time_between_updates = 10;

        /// <summary>Adjusts the speed of all the particles.</summary>
        private const int absolute_time = 5000;

        /// <summary>Maximum allowed amount of particles which can be shown at once.</summary>
        private const int max_particles_amount = 350;

        /// <summary>The size of a single particle.</summary>
        private const float particle_size = 2;

        /// <summary>The maximum scale of a single particle.</summary>
